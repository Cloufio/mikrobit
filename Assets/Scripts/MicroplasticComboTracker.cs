...
public sealed class MicroplasticComboTracker : MonoBehaviour
{
    ...
    private static readonly List<ComboDefinition> Definitions = new()
    {
        new ComboDefinition("microfiber-clutter", "Microfiber Clutter", "3x Fiber",
            "Menggabungkan serat sintetis saat mencuci pakaian berbahan polyester/nilon di mesin cuci dapat melepaskan lebih dari 700.000 serat mikroplastik ke saluran air sekali cuci!",
        ...
        new ComboDefinition("shattered-bottle", "Shattered Bottle", "2x Fragment + 1x Used Plastic Bottle",
            "Botol plastik utuh (makroplastik) yang mengapung di laut akan terdegradasi oleh sinar UV dan paparan ombak hingga retak menjadi jutaan serpihan fragment yang tajam.",
        ...
        new ComboDefinition("microbead-scrub", "Microbead Scrub", "3x Pellet (Nurdle)",
            "Pellet/microbeads bulat kecil ini dulu sering digunakan dalam produk skincare (sabun cuci muka berscrub). Saat dibilas, butirannya langsung terbuang ke sungai karena terlalu kecil untuk disaring.",
        ...
        new ComboDefinition("degraded-plastic-sheet", "Degraded Plastic Sheet", "2x Film + 1x Seawater",
            "Kantong plastik kresek (film) butuh waktu hingga 500 tahun untuk hancur. Di laut, lembaran ini melunak dan terpecah menjadi film microplastics yang mudah tertelan penyu.",
        ...
        new ComboDefinition("styrofoam-dust", "Styrofoam Dust", "3x Foam (Styrofoam)",
            "Gabus makanan (Expanded Polystyrene) sangat rapuh. Saat hancur, ia berubah menjadi foam microplastics melayang yang sangat ringan dan mudah tertiup angin ke pemukiman.",
            new MaterialRequirement(MaterialType.Foam, 3)),
        new ComboDefinition("contaminated-fish", "Contaminated Fish", "2x Pellet + 1x Sea Fish",
            "Ikan sering mengira butiran pellet mikroplastik sebagai telur ikan atau plankton. Begitu tertelan, mikroplastik menumpuk di usus ikan dan masuk ke rantai makanan manusia.",
        ...
        new ComboDefinition("tire-rubber-dust", "Tire Rubber Dust", "2x Fragment + 1x Vehicle Tire",
            "Gesekan antara ban kendaraan dan jalan raya menghasilkan pecahan fragment mikroplastik karet. Ini adalah salah satu penyumbang mikroplastik terbesar di daratan!",
        ...
        new ComboDefinition("synthetic-tea-bag", "Synthetic Tea Bag", "2x Film + 1x Tea Bag",
            "Beberapa kantong teh celup berbahan dasar plastik sintetis. Menyeduhnya dengan air panas bisa melepaskan hingga 11,6 miliar mikroplastik langsung ke cangkir tehmu!",
        ...
        new ComboDefinition("microplastic-soup", "Microplastic Soup", "1x Pellet + 1x Fragment + 1x Fiber",
            "Campuran berbagai jenis mikroplastik di laut sering terkonsumsi oleh manusia tanpa disadari. Rata-rata manusia mengonsumsi 5 gram mikroplastik per minggu—setara bobot 1 kartu kredit!",
        ...
        new ComboDefinition("inhaled-fiber", "Inhaled Fiber", "2x Fiber + 1x Lung / Organ",
            "Partikel fiber dari pakaian sintetis dan karpet yang melayang di udara cukup kecil untuk terhirup oleh manusia dan terperangkap di dalam jaringan paru-paru.",
        ...
        new ComboDefinition("leached-plastic", "Leached Plastic", "2x Fragment + 1x Microwave Plastic Container",
            "Memanaskan wadah plastik di dalam microwave menyebabkan plastik mengalami keretakan mikro dan melepaskan jutaan partikel fragment mikroplastik langsung ke makanan.",
        ...
        new ComboDefinition("plastified-salt", "Plastified Salt", "2x Pellet + 1x Sea Salt",
            "Sebagian besar garam dapur berbasis air laut di seluruh dunia ditemukan mengandung jejak butiran mikroplastik (pellet/microbeads) akibat tingginya polusi di perairan tempat pembuatan garam.",
        ...
        new ComboDefinition("paint-flakes", "Paint Flakes", "2x Fragment + 1x Ship or Wall Paint",
            "Cat dinding dan cat pelindung kapal yang mengelupas merupakan salah satu bentuk pecahan fragment mikroplastik tersembunyi yang mengapung di lautan.",
        ...
        new ComboDefinition("brittle-trash", "Brittle Trash", "2x Foam + 1x Plastic Straw",
            "Sampah plastik keras seperti sedotan dan kotak styrofoam jika terus terjemur panas matahari akan kehilangan kelenturannya dan hancur menjadi partikel mikro yang tajam.",
        ...
        new ComboDefinition("toxic-leachate", "Toxic Leachate", "1x Film + 1x Fragment + 1x Groundwater",
            "Air hujan yang mengguyur TPA membawa resapan serpihan film dan fragment mikroplastik masuk merembes ke dalam tanah, mengancam kualitas air sumur warga sekitar.",
